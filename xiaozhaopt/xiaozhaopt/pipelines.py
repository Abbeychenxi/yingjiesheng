...
class Industry:
    def __init__(self):
        ...
        education = set([u'教育', u'教师', u'校长', u'教学', u'老师'])
        medicalCare = set([u'医生', u'医院', u'妇幼保健'])
        music = set([u'音乐'])
        software = set([u'软件', u'软件工程', u'运维', u'系统', u'erp', u'java', u'c++', u'android', u'算法', u'驱动', u'ios', u'前端', u'测试', u'.net', u'it', u'手机', u'移动', u'c', u'研究所', u'计算机', u'flash', u'intern', u'程序开发', u'engineer', u'评测', u'信息技术'])
        biological = set([u'生物', u'细胞', u'血清', u'染色体', u'军事医学科学院', u'医学'])
        pharmacy = set([u'制药', u'医药', u'药剂'])
        civil = set([u'土木', u'建筑', u'给排水', u'暖通'])
        machinery = set([u'机械', u'飞行器', u'航空', u'硬件', u'操作工', u'汽车'])
