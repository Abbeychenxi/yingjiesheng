...
from xiaozhaopt.items import XiaozhaoptItem
...
class Yjspt(CrawlSpider):
    ...
    def parse_page(self, response):
        ...
        flag = True
        if u'\u5b9e\u4e60' in item['title'] and flag:
            flag = False
            item['positionType'] = [u'\u5b9e\u4e60']
            if u'\u517c\u804c' in item['title']:
                item['positionType'] = [u'\u5b9e\u4e60&\u517c\u804c']
        elif u'\u517c\u804c' in item['title'] and u'\u5b9e\u4e60' not in item['title'] and flag:
            item['positionType'] = [u'\u517c\u804c']
